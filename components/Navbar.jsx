...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center w-full h-full px-2 2xl:px-16 bg-gradient-to-b from-[#ffffff] to-[#e2dbdd]">
        ...
        <div className="flex justify-end items-center space-x-4 my-5 w-full sm:w-[80%]">
          <a
            href="https://www.facebook.com/botinasprado"
            target="_blank"
            rel="noreferrer"
          >
            <div className="rounded-full p-3 cursor-pointer hover:scale-105 ease-in duration-300  bg-white text-[#000000]">
              <FaFacebook />
            </div>
          </a>
          <a
          ...
          <a href="https://wa.link/lmeph0" target="_blank" rel="noreferrer">
            <div className="rounded-full p-3 cursor-pointer hover:scale-105 ease-in duration-300  bg-white text-[#000000]">
              <FaWhatsapp />
            </div>
          </a>
